                                      ...
                                      `runNightlySyncCycle`): 1) descubrimiento de ventas nuevas, 2) auto-resolución
                                        de ID de Fasig-Tipton, 3) sincronización de catálogo/precios, 4) barrido de
                                          ...
                                          - **Precio en vivo**: cron aparte cada 10 min, SOLO durante una jornada de
                                            ...
                                            | Ítem | Estado | Notas |
                                            |---|---|---|
                                            | Captura de fotografías (Front/Side/Rear) | Verificada en producción | Corrección de causa raíz del flujo de captura, probada en iPhone y iPad reales. |
                                            | Reconocimiento automático de vista (Front/Side/Rear) | Verificada en producción | Auto-clasificación de vista funcionando. |
                                            | Validación verde/rojo por foto | Verificada en producción | Validación apenas se toma cada foto (no recién al completar las 3); reemplazo de foto rechazada confirmado (rojo→verde) sin bloqueos ni alertas molestas. |
